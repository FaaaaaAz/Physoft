      ...
      <div className="analysis-view-container">
        ...
        <section className="analysis-section">
          ...
          {analysis.inertiaForceControl && (
            <div className="analysis-item">
              <h3>6. Análisis de Control de Fuerza Inercia</h3>
        ...
        {analysis.globalClassification && (
          <section className="analysis-section">
            ...
            <div className={`classification-badge classification-${analysis.globalClassification}`}>
              {analysis.globalClassification === 'high' && 'Por Encima del Promedio'}
              {analysis.globalClassification === 'medium' && 'En el Promedio'}
              {analysis.globalClassification === 'low' && 'Por Debajo del Promedio'}
            </div>
          </section>
        )}
